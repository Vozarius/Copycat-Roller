...
fills every Copycat Byte it finds. Each Byte remains tied to its own paving
level, so finding a deeper Byte cannot redirect Create past intermediate depth
steps.
